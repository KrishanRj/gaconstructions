...
<footer class="sticky-footer">
  <div class="container">
    <div class="text-center">
      <small>Copyright © gaconstructions 2019</small>
    </div>
  </div>
</footer>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="<?php echo base_url()."index.php/Login/logoutUser"; ?>">Logout</a>
      </div>
    </div>
  </div>
</div>
...
<script src="<?php echo base_url()."assets1/js/sb-admin-datatables.min.js"; ?>"></script>
<script src="<?php echo base_url()."assets1/js/sb-admin-charts.min.js"; ?>"></script>
</div>
</body>
